...
const MODEL_LOGOS: Record<string, { icon: React.ReactNode; color: string; bg: string }> = {
  ...
  deepseek: {
    color: 'text-cyan-400',
    bg: 'bg-cyan-500/10 border-cyan-500/20 group-hover:border-cyan-500/40',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  perplexity: {
    color: 'text-teal-400',
    bg: 'bg-teal-500/10 border-teal-500/20 group-hover:border-teal-500/40',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <div className="text-sm font-bold text-zinc-100 group-hover:text-emerald-400 transition-colors truncate">
                    {m.name}
                  </div>
          ...
          {professionsList.map((r: any) => {
            ...
            return (
              <Link
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#12161F]/80 border border-zinc-800 text-xs font-semibold text-zinc-300 hover:text-white hover:border-cyan-500/50 transition group"
              >
