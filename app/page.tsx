  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <section className="text-center py-10 md:py-16">
        ...
        {/* Metrics Bar */}
        <div className="grid grid-cols-3 max-w-lg mx-auto mt-10 pt-6 border-t border-slate-700/60 text-center">
          <div>
      ...
      {/* EXPLORE BY AI MODEL */}
      <section className="mb-14 border-t border-slate-700/60 pt-10">
          ...
          {modelsList.map((m: any) => {
            ...
            return (
              <Link
                key={m.id || m.slug}
                href={`/models/${m.slug}`}
                className="flex items-center gap-3.5 p-4 rounded-2xl bg-[#1e2330] border border-slate-700/70 hover:border-emerald-500/50 hover:bg-[#252b3b] transition group shadow-md"
              >
          ...
          {professionsList.map((r: any) => {
            ...
            return (
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#1e2330] border border-slate-700/70 text-xs font-semibold text-slate-200 hover:text-white hover:border-cyan-500/50 transition group shadow-sm"
              >
