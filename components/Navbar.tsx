    ...
    <header className="sticky top-0 z-40 border-b border-[#30363D]/80 bg-[#161B22]/90 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link
            href="/directory"
            className="text-xs font-semibold text-slate-300 hover:text-emerald-400 px-3 py-1.5 rounded-lg hover:bg-[#21262D] transition"
          >
            Directory
          </Link>
          <Link
            href="/workflows"
            className="text-xs font-semibold text-slate-300 hover:text-emerald-400 px-3 py-1.5 rounded-lg hover:bg-[#21262D] transition flex items-center gap-1.5"
          >
          ...
          <Link
            href="/submit"
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-bold transition shadow-md shadow-emerald-500/20"
          >
